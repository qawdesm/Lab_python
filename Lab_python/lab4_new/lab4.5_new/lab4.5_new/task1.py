...
print(f"Сгенерировано {len(df)} записей тестовых данных")
...
growth_by_product = (monthly_by_product
                     .groupby('Товар')
                     .apply(growth_summary, include_groups=False)
                     .round(1))
...
print("\nФайлы сохранены:")
print("1. анализ_продаж.xlsx - полные данные с расчетами")
print("2. рост_по_товарам.xlsx - динамика по товарам")
print("3. рост_по_точкам.xlsx - динамика по точкам")
print("4. прогноз_по_товарам.xlsx - прогнозы на следующий месяц")